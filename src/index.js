    ...
    (async () => {
      ...
      if (typeof option.dictionary !== 'undefined') {
        ...
        if (option.dictionary !== null) {
          ...
          if (result === 'NOT_FOUND') {
            alert(
              `ERROR:起動オプションdictionaryで指定されたファイル\n[ ${option.dictionary} ] が見つかりません。\n通常辞書で起動します。`,
            );
      ...
      // お絵カキコデータ読込タイムアウト時間
      this.axpObj.oekakiTimeout = isNaN(option.oekakiTimeout)
        ? 15000
        : option.oekakiTimeout;
      ...
      if (typeof option.minWidth === 'number') {
        if (
          inRange(
            option.minWidth,
            this.axpObj.CONST.MIN_SYSTEM_WIDTH,
            this.axpObj.CONST.MAX_SYSTEM_WIDTH,
          )
        ) {
      ...
      if (typeof option.minHeight === 'number') {
        if (
          inRange(
            option.minHeight,
            this.axpObj.CONST.MIN_SYSTEM_HEIGHT,
            this.axpObj.CONST.MAX_SYSTEM_HEIGHT,
          )
        ) {
      ...
      // );
      if (
        this.axpObj.minWidth > this.axpObj.maxWidth ||
        this.axpObj.minHeight > this.axpObj.maxHeight
      ) {
        alert(
      ...
      this.axpObj.restrictDraftCanvasResizing =
        option.restrictDraftCanvasResizing || false;
      ...
      const isRangeLength = (value) =>
        typeof value === 'number' && inRange(value, 1, 1024);
        ...
        if ('input' in option.postForm && !isErrorDetected) {
          if ('isDisplay' in option.postForm.input && !isErrorDetected) {
            if (
              ...
              this.axpObj.postForm.input.isDisplay =
                option.postForm.input.isDisplay;
            }
          }
          // 投稿者名
          if ('strName' in option.postForm.input && !isErrorDetected) {
            if (
              'isDisplay' in option.postForm.input.strName &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strName.isDisplay =
                  option.postForm.input.strName.isDisplay;
              }
            }
            if (
              'isInputRequired' in option.postForm.input.strName &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strName.isInputRequired =
                  option.postForm.input.strName.isInputRequired;
              }
            }
            if (
              'maxLength' in option.postForm.input.strName &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strName.maxLength =
                  option.postForm.input.strName.maxLength;
              }
            }
            if (
              'placeholder' in option.postForm.input.strName &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strName.placeholder =
                  option.postForm.input.strName.placeholder;
              }
            }
          }
          ...
          if ('strTitle' in option.postForm.input && !isErrorDetected) {
            if (
              'isDisplay' in option.postForm.input.strTitle &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strTitle.isDisplay =
                  option.postForm.input.strTitle.isDisplay;
              }
            }
            if (
              'isInputRequired' in option.postForm.input.strTitle &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strTitle.isInputRequired =
                  option.postForm.input.strTitle.isInputRequired;
              }
            }
            if (
              'maxLength' in option.postForm.input.strTitle &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strTitle.maxLength =
                  option.postForm.input.strTitle.maxLength;
              }
            }
            if (
              'placeholder' in option.postForm.input.strTitle &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strTitle.placeholder =
                  option.postForm.input.strTitle.placeholder;
              }
            }
          }
          ...
          if ('strMessage' in option.postForm.input && !isErrorDetected) {
            if (
              'isDisplay' in option.postForm.input.strMessage &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strMessage.isDisplay =
                  option.postForm.input.strMessage.isDisplay;
              }
            }
            if (
              'isInputRequired' in option.postForm.input.strMessage &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
            ...
            if (
              'maxLength' in option.postForm.input.strMessage &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strMessage.maxLength =
                  option.postForm.input.strMessage.maxLength;
              }
            }
            if (
              'placeholder' in option.postForm.input.strMessage &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strMessage.placeholder =
                  option.postForm.input.strMessage.placeholder;
              }
            }
          }
          ...
          if ('strWatchList' in option.postForm.input && !isErrorDetected) {
            if (
              'isDisplay' in option.postForm.input.strWatchList &&
              !isErrorDetected
            ) {
              if (
                checkOptionValue(
                ...
                this.axpObj.postForm.input.strWatchList.isDisplay =
                  option.postForm.input.strWatchList.isDisplay;
              }
            }
          }
        ...
        if ('notice' in option.postForm && !isErrorDetected) {
          if ('isDisplay' in option.postForm.notice && !isErrorDetected) {
            if (
              ...
              this.axpObj.postForm.notice.isDisplay =
                option.postForm.notice.isDisplay;
            }
          }
        }
      ...
      // htmlを生成
      this.axpObj.paintBodyElement.insertAdjacentHTML(
        'afterbegin',
        this.axpObj.translateHTML(htmldata),
      );

      let targetElements_tab = document.querySelectorAll(
